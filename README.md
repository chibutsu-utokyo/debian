...
### AIコーディングエージェントのインストール（任意）
興味がある人は以下のAIコーディングエージェントを個別または一括でインストールしてください．
...
とりあえず使ってみるだけであればGithub Educationに登録してGitHub Copilot CLIを使うか，
OpenCodeの無料モデルを使うのがお手軽かと思います．
